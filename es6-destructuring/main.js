...
console.log(`The title of the book is ${title}, the author is
${author}, and the library id is ${libraryID}`);
...
console.log(`The title of the book is ${titleBook2}, the author is
${authorBook2}, and the library id is ${libraryIDBook2}`);
